...
(function () {
    ...
    const CHAPTERS = [
        ...
        { file: 'chapters/chapter-3.md', title: 'What Are Large Language Models?', num: 3 },
        { file: 'chapters/chapter-4.md', title: 'Neural Networks — The Brain Behind AI', num: 4 },
        { file: 'chapters/chapter-5.md', title: 'Transformers — The Architecture That Changed Everything', num: 5 },
        { file: 'chapters/chapter-6.md', title: 'Training, Fine-Tuning, and Prompt Engineering', num: 6 },
        { file: 'chapters/chapter-7.md', title: 'Embeddings, Vector Databases, and RAG', num: 7 },
        { file: 'chapters/chapter-8.md', title: 'AI Agents and Tool Use', num: 8 },
